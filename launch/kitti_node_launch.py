...
def launch_setup(context):
    ...
    dataset = context.launch_configurations.get('dataset', 'kitti_15')
    ...
    data_dir_path = os.path.join(pkg_share_dir, 'data', f'data_{dataset}')
    rviz_config_path = os.path.join(pkg_share_dir, 'rviz', 'kitti_node.rviz')
